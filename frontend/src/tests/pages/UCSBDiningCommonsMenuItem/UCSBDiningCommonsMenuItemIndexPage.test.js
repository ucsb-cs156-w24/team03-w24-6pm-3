...
import UCSBDiningCommonsMenuItemIndexPageStories from "stories/pages/UCSBDiningCommonsMenuItem/UCSBDiningCommonsMenuItemIndexPage.stories";
...
describe("UCSBDiningCommonsMenuItemIndexPage tests", () => {
    ...
    test("renders three items correctly for regular user", async () => {
        setupUserOnly();
        axiosMock.onGet("/api/ucsbdiningcommonsmenuitem/all").reply(200, ucsbDiningCommonsMenuItemFixtures.threeMenu);
        ...
        const name = screen.getByText("Caesar Salad");
        expect(name).toBeInTheDocument();

        const station = screen.getByText("Salad");
